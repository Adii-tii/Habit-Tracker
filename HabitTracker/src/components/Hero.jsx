    ...
    return(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="text-yellow-400">Loop In</span> to Better Habits
          </h1>
          <p className="text-3xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Build your routine. One small loop at a time.
          </p>
          <p className="text-lg text-gray-500 mb-12 max-w-3xl mx-auto">
            Track your daily habits with ease. Stay consistent, celebrate progress, and create the life you want – to improve is just human; they key is to keep improving.
          </p>
